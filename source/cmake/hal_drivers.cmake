...
if(NOT stm32cubemp1_POPULATED)
    ...
    set(stm32cubemp1_VERSION_STRING "1.4.0")
...
set(LINKER_SCRIPTS_DIR ${CMAKE_SOURCE_DIR}/LinkerScripts)

else()
# Use pre download STM32Cube_FW_MP1 repository

set(HAL_DIR ${STM32CUBE_FW_MP1}/Drivers/STM32MP1xx_HAL_Driver)
set(CMSIS_DIR ${STM32CUBE_FW_MP1}/Drivers/CMSIS)
set(LINKER_SCRIPTS_DIR ${CMAKE_SOURCE_DIR}/LinkerScripts)
...
set(LINKER_FILE "${LINKER_SCRIPTS_DIR}/STM32MP157CAAX_RAM.ld")
